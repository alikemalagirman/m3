        ...
        <Grid container direction="column">
            ...
            <Grid item container 
                ...
                <Grid item container direction="column" lg style={{maxWidth:"40em"}}>
                    <Grid item>
                        <Typography align ={matchesMD?"center":"right"} variant="h2" gutterBottom>
                            Vision
                        </Typography>
                    </Grid>
                    <Grid item>
                ...
                <Grid item container direction="column" lg style={{maxWidth:"40em"}}>
                    ...
                    <Grid item>
                        ...
                        <Typography align ={matchesMD?"center":undefined} variant="body1" paragraph >
                            ...
                            singular purpose.at the heart of everything we do.  
                        </Typography>
                        <Typography align ={matchesMD?"center":undefined} variant="body1" paragraph >
                ...
                <Grid item container direction="column" lg alignItems={matchesMD?"center":undefined}>
                    ...
                    <Grid item >
                        <Typography align ={matchesMD?"center":undefined}
                            variant="body1" paragraph style={{color:"#fff", maxWidth:"20em"}} >
            ...
            <Grid item container direction={matchesMD?"column":"row"} justify ="center" className={classes.rowContainer}
                ...
                <Grid item lg style={{alignSelf:"center"}}>
                    <img src={mockup} alt="basic website design outline" width="100%" style={{maxWidth:matchesMD?700:1000}}/>
                </Grid>                
            </Grid>
            ...
            <Grid item container direction={matchesMD?"column":"row"} justify ="center" className={classes.rowContainer}
                ...
                <Grid item lg style={{alignSelf:"center"}}>
                    <img src={design} alt="paintbrush leaving stroke of paint" width="100%"/>
                </Grid>                
            </Grid>
            ...
            <Grid item container direction={matchesMD?"column":"row"} justify ="center" 
            ...
            <Grid item container direction={matchesMD?"column":"row"} justify ="center" className={classes.rowContainer}
                ...
                <Grid item lg style={{alignSelf:"center"}} >
                    <img src={maintain} alt="wrench tightening bolts" style={{maxWidth:500}} width="100%"/>
                </Grid>                
            </Grid>
